...
. Variables and constants in RAM (global, static), used 29400 / 80192 bytes (36%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ DATA     1524     initialized variables
╠══ RODATA   1148     constants       
╚══ BSS      26728    zeroed variables
. Instruction RAM (IRAM_ATTR, ICACHE_RAM_ATTR), used 61979 / 65536 bytes (94%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ ICACHE   32768    reserved space for flash instruction cache
╚══ IRAM     29211    code in IRAM    
. Code in flash (default, ICACHE_FLASH_ATTR), used 270780 / 1048576 bytes (25%)
║   SEGMENT  BYTES    DESCRIPTION
╚══ IROM     270780   code in flash   
with DTH20
. Variables and constants in RAM (global, static), used 29424 / 80192 bytes (36%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ DATA     1524     initialized variables
╠══ RODATA   1148     constants       
╚══ BSS      26752    zeroed variables
. Instruction RAM (IRAM_ATTR, ICACHE_RAM_ATTR), used 61979 / 65536 bytes (94%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ ICACHE   32768    reserved space for flash instruction cache
╚══ IRAM     29211    code in IRAM    
. Code in flash (default, ICACHE_FLASH_ATTR), used 273644 / 1048576 bytes (26%)
║   SEGMENT  BYTES    DESCRIPTION
╚══ IROM     273644   code in flash   
with OLED
...
╠══ ICACHE   32768    reserved space for flash instruction cache
╚══ IRAM     29211    code in IRAM    
. Code in flash (default, ICACHE_FLASH_ATTR), used 274412 / 1048576 bytes (26%)
║   SEGMENT  BYTES    DESCRIPTION
╚══ IROM     274412   code in flash  
    *************************************************/


#define APP_NAME "betaEvents32Hard V1.0"
